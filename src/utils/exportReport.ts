...
export function exportReportToCsv(
  ...
  lines.push(escapeCell('1994 COFFEE - HỆ THỐNG POS BÁN HÀNG'))
...
export function printReportHtml(
  ...
  const html = `
    ...
    <body>
      <div class="header">
        <div class="brand">1994 COFFEE - HỆ THỐNG POS</div>
...
export function printShiftClosingSlip(data: ShiftClosingData) {
  ...
  const html = `
    ...
    <head>
      <meta charset="UTF-8" />
      <title>Phiếu Chốt Ca - 1994 Coffee</title>
      <style>
        @page {
          size: 80mm auto;
          margin: 0;
    ...
    <body>
      <div class="text-center">
        <div style="font-size: 15px; font-weight: bold;">1994 COFFEE</div>
